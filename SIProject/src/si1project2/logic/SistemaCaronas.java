...
public class SistemaCaronas {
	private Map<String, Sessao> mapIdSessao = new TreeMap<String, Sessao>(); // contem
																				// apenas
																				// sessoes
																				// abertas
	...
	public String solicitarVagaPontoEncontro(String idSessao, String idCarona,
		...
		return donoDaCarona
				.solicitarVagaPontoEncontro(idCarona,
						donoDaCarona.getIdUsuario(),
						solicitante.getIdUsuario(), pontos);
	}
	...
	public String getAtributoPerfil(String login, String atributo)
		...
		for (Usuario u : mapIdUsuario.values())
			if (u.getLogin().equals(login))
				return ((Perfil) u.getAtributo("perfil")).getAtributo(atributo)
						.toString();
